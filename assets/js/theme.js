...
var getColor = function getColor(name) {
  ...
  return getComputedStyle(dom).getPropertyValue("--aranyak-".concat(name)).trim();
};
...
var navbarInit = function navbarInit() {
  ...
  if (navbar) {
    ...
    var handleAlpha = function handleAlpha() {
      ...
      navbar.style.backgroundColor = "rgba(224, 224, 224, ".concat(opacity, ")");
      navbarContainer.style.backgroundColor = "rgba(224, 224, 224, ".concat(opacity, ")");
